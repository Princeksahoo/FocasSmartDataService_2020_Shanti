...
namespace DTO
{
    ...
    public class ServiceSettingsVals
    {
        ...
        public short ProgramPullLocationFlag { get; set; }
        public short ProgramPullProgramLocation { get; set; }
        public short ProgramPushLocationFlag { get; set; }
        public short ProgramPushProgramLocation { get; set; }
